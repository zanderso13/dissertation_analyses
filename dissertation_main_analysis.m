...
hyper= 1; overwrite_hyper = 1; % hardcoded which seed you're looking at
...
if whole_brain_networks == 1
    ...
    if overwrite_nii == 1
        for f = 1:length(fnames)
            load(fnames{f});
            pid=fnames{f}(1:5);
            final_brain=fmri_data('/Users/zacharyanderson/Documents/ACNlab/BrainMAPD/beta_series/sub-10001/ses-2/gain_contrasts/run-1/beta_0001.nii');
            final_brain.dat = atanh(final_corr_acc_whole); % vs amyg acc ofc
            final_brain.fullpath = strcat(pid,'_acc_antgain.nii');
    ...
    full_fnames = filenames(fullfile(strcat('/Users/zacharyanderson/Documents/ACNlab/BrainMAPD/mid_corr_matrices/final_corr_mats/*',region_name_for_wholebrain_analysis,'*nii')));
...
if whole_brain_mediation_analysis == 1
    ...
    cd('/Users/zacharyanderson/Documents/ACNlab/BrainMAPD/mid_corr_matrices/final_corr_mats/mediation_results_antgain/general_distress')
    ...
    cd('/Users/zacharyanderson/Documents/ACNlab/BrainMAPD/mid_corr_matrices/final_corr_mats/mediation_results_antgain/anhedonia')
    ...
    cd('/Users/zacharyanderson/Documents/ACNlab/BrainMAPD/mid_corr_matrices/final_corr_mats/mediation_results_antgain/fears')
...
if hyper == 1
    ...
    for f = 1:length(fnames)
        ...
        unaligned_mats{f} = final_corr_acc_voxel_to_region;
    end
    ...
    mkdir(fullfile(basedir,"hyperalignment_results"))
